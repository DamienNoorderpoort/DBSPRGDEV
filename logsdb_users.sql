...
-- CHANGE MASTER TO MASTER_LOG_FILE='KKRLP-3-bin.000024', MASTER_LOG_POS=157;
...
REPLACE  IGNORE INTO `users` (`id`, `name`, `email`) VALUES (1,'geertje','geert05@gmail.com'),(2,'willem','geert@wneknkn.com'),(5,'Test','test@example.nl'),(8,'Wassim','wassim@gmail.com'),(11,'geert','geert@gmail.com'),(12,'willem','willem@gmail.com'),(14,'erik','erikuters@gmail.com'),(15,'marc','marc@outlook.com'),(16,'merijn','ruitermerijn06@gmail.com');
UNLOCK TABLES;
